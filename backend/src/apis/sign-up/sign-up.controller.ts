...
export async function signupProfile(request: Request, response: Response) : Promise<Response|undefined>  {
    try {
...
<p>In order to start post ratings please sign into your account </p>
